...
?>
  ...
  <a href="COMPLETED.php" style="background-color: #00bc8c; border-radius: 10px;">Completed</a>
...
<div class="konten">
  <br>
  <h1 style="letter-spacing: 3px;">Completed</h1>
  <hr>
<div class="row">
  <?php
    $cari = "SELECT * FROM tb_novels WHERE status_novel = 'Completed' order by id_novel DESC";
