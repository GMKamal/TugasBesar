...
<div class="konten">
  <?php
    ...
    while ($data = mysqli_fetch_assoc($tampil)){
      ?>
  <br>
  <h1 style="letter-spacing: 3px;"><?php echo $data['judul_novel']; ?></h1>
  <hr>
<div class="row">
      <div class="column">
      ...
      <div class="column1">
        <h2 style="letter-spacing: 3px;">Details</h2>
        <table>
          <tr>
            <th>Judul</th>
            <th>:</th>
        ...
        <h2 style="letter-spacing: 3px;">Novel Summary</h2>
        <p style="text-align: justify; padding: 5px; letter-spacing: 0.5px;"><?php echo $data['deskripsi_novel']; ?></p>
        <?php
        if (isset($_SESSION['user'])){
          $bk = 0;
          $idn = $_GET['id_novel'];
        ...
        ?>
        <h2 style="letter-spacing: 3px;">Chapters</h2>
        <table>
          <tr>
            <th>NO</th>
            <th>Chapter</th>
