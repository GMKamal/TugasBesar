...
<div class="konten">
  ...
  <br>
  <h1 style="letter-spacing: 3px;"><?php echo $data['chapter']; ?></h1>
  <hr>
<div class="row">
      <div class="column">
        <?php
      ...
      <div class="column1">
        <?php echo "<a class='link' style='text-decoration: none;' href='NOVEL.php?id_novel=".$data['id_novel']."'>"; ?>
          <h4 style="letter-spacing: 2px;">|-<?php echo $data['judul_novel']; ?>-|</h4></a>
        <p style="text-align: justify; padding: 35px 7%; letter-spacing: 0.3px;"><?php echo $data['isi']; ?></p>
      </div>
