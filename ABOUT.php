...
?>
  ...
  <a href="ABOUT.php" style="background-color: #00bc8c; border-radius: 10px;">About</a>
...
<div class="row">
  <div class="column">
    <p class="button" style="border-radius:7px; margin-bottom: 15px; letter-spacing: 1px;"><b>TBNovel adalah situs untuk membaca novel online secara gratis.<br><br>
